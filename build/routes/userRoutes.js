...
router.post('/logout', authMiddlware_1.protect, userController_1.logoutUser);
router.route('/profile').get(authMiddlware_1.protect, userController_1.getUserProfile).put(authMiddlware_1.protect, userController_1.updateUserProfile);
router.route('/:id').get(authMiddlware_1.protect, authMiddlware_1.admin, userController_1.getUserById)
